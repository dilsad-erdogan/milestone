...
export default function QuizTimer({ initialTime, onTimeUp, onTick, isActive }: QuizTimerProps) {
    ...
    useEffect(() => {
        // LocalStorage'dan süreyi kontrol et (sayfa yenilenirse)
    ...
    return (
        <div className={`flex items-center gap-2 font-mono text-lg font-bold ${timeLeft < 60 ? 'text-red-500 animate-pulse' : 'text-slate-600'}`}>
